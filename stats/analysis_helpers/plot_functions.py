...
def generate_all_plots():
    # Dataset 1 plots
    runtime_plot_1("runtime_on_dataset_1")
    objective_plot_1("objectives_on_dataset_1")
    util_plot_1("Batch-util-dataset_1")

    # Dataset 2 plots
    runtime_plot_2("Runtime_on_dataset_2")
    util_plot_2("Batch-util-dataset_2")

    # Dataset 4 plots
    runtime_plot_4("Runtime-on-dataset-4")
    util_plot_4("Batch-util-dataset-4")

    # Dataset 5 plots
    runtime_plot_5("Runtime-on-dataset-5")
    util_plot_5("Batch-util-dataset-5")

    # Dataset 6 plots
    runtime_plot_6("Runtime-on-dataset-6")
    util_plot_6("Batch-util-dataset-6")

    # Batch-utilization plots

    # Local search optimizations and analysis on datasets 3 & 7
    runtime_gls_plot("Runtime-dataset-3-local-search")
    runtime_gls_2_plot("Change-in-objective-dataset-3")
    runtime_gls_3_plot("Change-in-objective-dataset-7")


# ======== Dataset 1 plots ============
def runtime_plot_1(file_name: str):
    files = [
...
def objective_plot_1(file_name: str):
    files = [
        "data/results/objective/Greedy-local-search: CPLEX "
        "Re-optimization/results_dataset_1.json",
        "data/results/objective/Active-time-IP/results_dataset_1.json"
...
# ======== Dataset 2 plots ============
def runtime_plot_2(file_name: str):
    plt.clf()
    files = [
...
# ======== Dataset43 plots ============
def runtime_plot_4(file_name: str):
    files = [
        "data/results/runtime/Greedy-local-search: CPLEX "
...
def runtime_plot_5(file_name: str):
    plt.clf()
    files = [
        "data/results/runtime/Greedy-local-search: CPLEX "
...
def runtime_plot_6(file_name: str):
    files = [
        "data/results/runtime/Greedy-local-search: CPLEX "
...
def runtime_gls_plot(file_name: str):
    files = [
...
def runtime_gls_2_plot(file_name: str):
    files = [
        "data/results/runtime/Greedy-local-search: CPLEX (V1)/results_dataset_3.json",
        "data/results/runtime/Greedy-local-search: CPLEX (V2)/results_dataset_3.json",
    ]
...
def runtime_gls_3_plot(file_name: str):
    files = [
