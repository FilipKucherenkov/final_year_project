...
class SyntheticDataGenerator:
    ...
    def generate_release_times_for_jobs(jobs: list[Job], t: int, alpha: float = 0.9) -> None:
        ...
        :param alpha: alpha parameter for random generation. (Default value is 0.9) @TODO: Select randomly from [0,1] in the future
        """
        for job in jobs:
    ...
    @staticmethod
    def generate_deadlines_for_jobs(jobs: list[Job], t: int, alpha: float = 0.1) -> None:
        """
        Given a list of jobs, generate a random deadline for each job
        :param jobs: jobs to receive deadlines
        :param t: number of discrete timeslots.
        :param alpha: alpha parameter for random generation. (Default value is 0.1) @TODO: Select randomly from [0,1] in the future
        """
        for job in jobs:
