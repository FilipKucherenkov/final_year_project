...
def greedy_local_search_with_cplex(instance: ProblemInstance, solver_type: str):
    ...
    initial_schedule = solve_maxflow_cplex(network.arcs, network.source_node, network.sink_node, total_sum)
    ...
    for timeslot in time_horizon.time_slots:
        ...
        schedule = solve_maxflow_cplex(network.arcs, network.source_node, network.sink_node, total_sum)
