...
def greedy_local_search_with_reopt(instance: ProblemInstance, solver_type: str):
    ...
    initial_schedule, initial_bounds = solve_maxflow_cplex_with_opt(network.arcs,
                                                                    network.source_node,
                                                                    network.sink_node,
                                                                    total_sum, {})
    ...
    for timeslot in time_horizon.time_slots:
        ...
        schedule, flow_bounds = solve_maxflow_cplex_with_opt(network.arcs, network.source_node, network.sink_node,
                                                             total_sum, initial_bounds)
