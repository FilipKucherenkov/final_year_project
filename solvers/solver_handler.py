...
def solve_instance(instance, algorithm, solver_type):
    ...
    :param algorithm: specified algorithm (e.g active-time-ip, max-flow or greedy_algorithms-maxflow)
    ...
    elif algorithm == "Greedy-local-search":
        return greedy_local_search(instance, solver_type)
    elif algorithm == "Greedy-local-search-with-opt":
        return greedy_local_search_with_cplex(instance, solver_type)
    elif algorithm == "Greedy-local-search-with-opt-v2":
