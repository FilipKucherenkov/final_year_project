...
from models.optimized_maxflow import opt_greedy_with_blackbox_heuristic
...
def main():
    instance1 = AnalysisInputGenerator.generate_infeasible_instance("Moderate set", -1)
    ...
    # schedule = opt_greedy_with_blackbox_heuristic(instance)
    schedule = greedy_with_blackbox_heuristic(instance2)
    schedule.print_schedule_info()

    # schedule2 = solve_active_time_ip(instance)
